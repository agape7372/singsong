...
| Preview owner              | app PID 30596 (`127.0.0.1:3000`), Cloudflare Quick Tunnel PID 32848                 |
...
사용자 승인에 따라 `main`의 Station public-origin fixture build를 app PID 30596으로 재게시했다.
...
app PID 30596과 tunnel PID 32848이 현재 preview를 소유한다. 종료하거나 재시작할 때는 root owner가 정확한
