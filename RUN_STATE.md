...
| Phase                      | `FOLDED_SESSION_S_REPUBLISHED_ACTIVE_PREVIEW`                                       |
...
Node 24.18/Next 16.2.11의 최신 Station 트리는 current format/lint/type, 39-file/194-test,
...
Folded Session S 적용 뒤 현재 app PID 43664로 재빌드·재시작했다. 헤더·manifest·Apple metadata는
...
app PID 43664와 tunnel PID 43376이 현재 preview를 소유한다. 종료하거나 재시작할 때는 root owner가 정확한
