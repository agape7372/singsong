...
`https://bond-athletics-calculations-putting.trycloudflare.com`은 2026-07-23 `main`의 Station 빌드로 재게시됐다. fixture app PID 30596과 Quick Tunnel PID 32848이 연결되어 있으며, 홈·참조 자산 14개·검색 API·manifest·service worker가 모두 200이고 공개 주소 대상 Chromium 전체 회귀도 13 pass·7 intentional skip으로 통과했다. 현재 판정은 `ACTIVE_PREVIEW/READY`이며 stable hosting 또는 production 배포는 아니다.
