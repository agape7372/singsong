...
describe("PrimaryNav", () => {
  it("uses one two-item navigation DOM with icons, labels, and aria-current", () => {
    ...
    expect(container.querySelectorAll(".primary-nav-icon svg[aria-hidden='true']")).toHaveLength(2);
  });
